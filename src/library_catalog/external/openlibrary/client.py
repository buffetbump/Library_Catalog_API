""" Асинхронный клиент для интеграции с эндпоинтами Open Library API """

import httpx
from typing import Any

from library_catalog.external.base.base_client import BaseApiClient
from library_catalog.domain.exceptions import OpenLibraryException, OpenLibraryTimeoutException


class OpenLibraryClient(BaseApiClient):
    """ Внешний клиент для интеграции с Open Library API """
