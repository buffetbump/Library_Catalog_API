...
Реализует логирование запросов и повторные попытки с увеличивающейся паузой.
"""
    ...
    async def _request(
        ...
        for attempt in range(self.retries):
            try:
                ...
                self.logger.warning(f"Timeout, retryin in {wait_time}s...")
                # Используем асинхронный сон, чтобы не блокировать Event Loop
        ...
        return {} # Заглушка для корректно типизации
