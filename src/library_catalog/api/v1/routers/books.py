"""
Роутер для обработки HTTP-запросов к каталогу книг.
Обеспечивает тонкую прослойку API layer без содержания бизнес-логики.
"""
...
from library_catalog.api.v1.schemas.book import(
    BookCreate,
    BookUpdate, 
    ShowBook,
    BookFilters,
)
from library_catalog.api.v1.schemas.common import PaginatedResponse, PaginationParams
from library_catalog.api.dependencies import BookServiceDep
